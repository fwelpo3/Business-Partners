...
export const QuestionForm: React.FC<QuestionFormProps> = ({ isOpen, onClose, onSubmit }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-60 backdrop-blur-sm">
      <div className="relative w-full max-w-lg p-6 m-4 bg-white rounded-lg shadow-xl dark:bg-gray-800">
        ...
        <h2 className="text-2xl font-bold mb-6 text-gray-900 dark:text-white">Frage stellen</h2>
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            <label htmlFor="question" className="block text-sm font-medium text-gray-700 dark:text-gray-300">Ihre Frage</label>
            <textarea
              id="question"
              rows={5}
              value={question}
